...
/*
 * VOUS DEVEZ IMPORTER TOUTES LES CLASS QUE VOUS UTILISEREZ !
 */
...
class EmployeController extends AbstractController
{
     ...
     * On privilégie l'anglais. À défaut, on nomme correctement ses variables en français
     *
    ...
    public function create(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if($form->isSubmitted() && $form->isValid()) {
            ...
            # Cette méthode pour récupérer les données des inputs est la première méthode.
            # Nous utiliserons la seconde, grâce au mécanisme d'auto hydratation de Symfony.
